...
const REGEX_SESSION_ID = /^(sessions\/)?\d+$/;
const REGEX_SOURCE = /^sources\/[^/]+\/[^/]+\/[^/]+$/;
const REGEX_ACTIVITY = /^sessions\/\d+\/activities\/\d+$/;
...
server.registerTool(
    'jules_show_source',
    {
        ...
        inputSchema: z.object({
            name: z.string().max(256).regex(REGEX_SOURCE, { message: "Invalid Source format" }).describe('Source name (e.g., sources/github/owner/repo)'),
        }).shape,
    },
...
server.registerTool(
    'jules_show_session',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(REGEX_SESSION_ID, { message: "Invalid Session ID format" }).describe('Session ID (e.g., 12345678 or sessions/12345678)'),
        }).shape,
    },
...
server.registerTool(
    'jules_create_session',
    {
        ...
        inputSchema: z.object({
            source: z.string().max(256).regex(REGEX_SOURCE, { message: "Invalid Source format" }).describe('Source name (e.g., sources/github/owner/repo)'),
...
server.registerTool(
    'jules_approve_plan',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(REGEX_SESSION_ID, { message: "Invalid Session ID format" }).describe('Session ID to approve'),
        }).shape,
    },
...
server.registerTool(
    'jules_send_message',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(REGEX_SESSION_ID, { message: "Invalid Session ID format" }).describe('Session ID to send message to'),
...
server.registerTool(
    'jules_delete_session',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(REGEX_SESSION_ID, { message: "Invalid Session ID format" }).describe('Session ID to delete'),
        }).shape,
    },
...
server.registerTool(
    'jules_list_activities',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(REGEX_SESSION_ID, { message: "Invalid Session ID format" }).describe('Session ID to list activities for'),
        }).shape,
    },
...
server.registerTool(
    'jules_show_activity',
    {
        ...
        inputSchema: z.object({
            activity_name: z.string().max(256).regex(REGEX_ACTIVITY, { message: "Invalid Activity Name format" }).describe('Activity name (e.g., sessions/123/activities/456)'),
        }).shape,
    },
