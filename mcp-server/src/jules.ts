...
const SOURCE_REGEX = /^sources\/[^/]+\/[^/]+\/[^/]+$/;
const SESSION_ID_REGEX = /^(sessions\/)?\d+$/;
const ACTIVITY_NAME_REGEX = /^sessions\/\d+\/activities\/\d+$/;
...
server.registerTool(
    'jules_show_source',
    {
        ...
        inputSchema: z.object({
            name: z.string().max(256).regex(SOURCE_REGEX).refine(val => !val.startsWith('-'), { message: "Source name cannot start with '-'" }).describe('Source name (e.g., sources/github/owner/repo)'),
        }).shape,
    },
...
server.registerTool(
    'jules_show_session',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(SESSION_ID_REGEX).refine(val => !val.startsWith('-'), { message: "Session ID cannot start with '-'" }).describe('Session ID (e.g., 12345678 or sessions/12345678)'),
        }).shape,
    },
...
server.registerTool(
    'jules_create_session',
    {
        ...
        inputSchema: z.object({
            source: z.string().max(256).regex(SOURCE_REGEX).refine(val => !val.startsWith('-'), { message: "Source name cannot start with '-'" }).describe('Source name (e.g., sources/github/owner/repo)'),
            ...
            title: z.string().max(1024).refine(val => !val.startsWith('-'), { message: "Title cannot start with '-'" }).optional().describe('Optional title for the session'),
...
server.registerTool(
    'jules_approve_plan',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(SESSION_ID_REGEX).refine(val => !val.startsWith('-'), { message: "Session ID cannot start with '-'" }).describe('Session ID to approve'),
        }).shape,
    },
...
server.registerTool(
    'jules_send_message',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(SESSION_ID_REGEX).refine(val => !val.startsWith('-'), { message: "Session ID cannot start with '-'" }).describe('Session ID to send message to'),
...
server.registerTool(
    'jules_delete_session',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(SESSION_ID_REGEX).refine(val => !val.startsWith('-'), { message: "Session ID cannot start with '-'" }).describe('Session ID to delete'),
        }).shape,
    },
...
server.registerTool(
    'jules_list_activities',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().max(256).regex(SESSION_ID_REGEX).refine(val => !val.startsWith('-'), { message: "Session ID cannot start with '-'" }).describe('Session ID to list activities for'),
        }).shape,
    },
...
server.registerTool(
    'jules_show_activity',
    {
        ...
        inputSchema: z.object({
            activity_name: z.string().max(256).regex(ACTIVITY_NAME_REGEX).refine(val => !val.startsWith('-'), { message: "Activity name cannot start with '-'" }).describe('Activity name (e.g., sessions/123/activities/456)'),
        }).shape,
    },
