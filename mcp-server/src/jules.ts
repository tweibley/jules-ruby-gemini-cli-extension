...
server.registerTool(
    'jules_show_source',
    {
        ...
        inputSchema: z.object({
            name: z.string().describe('Source name (e.g., sources/github/owner/repo)'),
        }).shape,
    },
...
server.registerTool(
    'jules_show_session',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().describe('Session ID (e.g., 12345678 or sessions/12345678)'),
        }).shape,
    },
...
server.registerTool(
    'jules_create_session',
    {
        ...
        inputSchema: z.object({
            ...
            branch: z.string().describe('Starting branch name (e.g., main)'),
            prompt: z.string().describe('Task description for Jules to work on'),
...
server.registerTool(
    'jules_approve_plan',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().describe('Session ID to approve'),
        }).shape,
    },
...
server.registerTool(
    'jules_send_message',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().describe('Session ID to send message to'),
            prompt: z.string().describe('Message to send to Jules'),
        }).shape,
    },
...
server.registerTool(
    'jules_list_activities',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().describe('Session ID to list activities for'),
        }).shape,
    },
...
server.registerTool(
    'jules_show_activity',
    {
        ...
        inputSchema: z.object({
            activity_name: z.string().describe('Activity name (e.g., sessions/123/activities/456)'),
        }).shape,
    },
