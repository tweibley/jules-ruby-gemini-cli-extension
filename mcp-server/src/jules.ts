...
server.registerTool(
    'jules_show_source',
    {
        ...
        inputSchema: z.object({
            name: z.string().regex(/^sources\/[^/]+\/[^/]+\/[^/]+$/, { message: "Source name must match format sources/provider/owner/repo" }).describe('Source name (e.g., sources/github/owner/repo)'),
        }).shape,
    },
...
server.registerTool(
    'jules_show_session',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().regex(/^(sessions\/)?\d+$/, { message: "Session ID must be numeric, optionally prefixed with 'sessions/'" }).describe('Session ID (e.g., 12345678 or sessions/12345678)'),
        }).shape,
    },
...
server.registerTool(
    'jules_create_session',
    {
        ...
        inputSchema: z.object({
            source: z.string().regex(/^sources\/[^/]+\/[^/]+\/[^/]+$/, { message: "Source name must match format sources/provider/owner/repo" }).describe('Source name (e.g., sources/github/owner/repo)'),
...
server.registerTool(
    'jules_approve_plan',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().regex(/^(sessions\/)?\d+$/, { message: "Session ID must be numeric, optionally prefixed with 'sessions/'" }).describe('Session ID to approve'),
        }).shape,
    },
...
server.registerTool(
    'jules_send_message',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().regex(/^(sessions\/)?\d+$/, { message: "Session ID must be numeric, optionally prefixed with 'sessions/'" }).describe('Session ID to send message to'),
...
server.registerTool(
    'jules_delete_session',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().regex(/^(sessions\/)?\d+$/, { message: "Session ID must be numeric, optionally prefixed with 'sessions/'" }).describe('Session ID to delete'),
        }).shape,
    },
...
server.registerTool(
    'jules_list_activities',
    {
        ...
        inputSchema: z.object({
            session_id: z.string().regex(/^(sessions\/)?\d+$/, { message: "Session ID must be numeric, optionally prefixed with 'sessions/'" }).describe('Session ID to list activities for'),
        }).shape,
    },
...
server.registerTool(
    'jules_show_activity',
    {
        ...
        inputSchema: z.object({
            activity_name: z.string().regex(/^sessions\/\d+\/activities\/\d+$/, { message: "Activity name must match format sessions/{id}/activities/{id}" }).describe('Activity name (e.g., sessions/123/activities/456)'),
        }).shape,
    },
