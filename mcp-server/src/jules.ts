    ...
    'jules_show_source',
    {
        ...
        inputSchema: z.object({
            name: z.string()
                ...
                .refine(val => /^sources\/[^/]+\/[^/]+\/[^/]+$/.test(val), { message: "Source name must match format: sources/provider/owner/repo" })
    ...
    'jules_show_session',
    {
        ...
        inputSchema: z.object({
            session_id: z.string()
                ...
                .refine(val => /^(sessions\/)?\d+$/.test(val), { message: "Session ID must be numeric or match format: sessions/123" })
    ...
    'jules_show_activity',
    {
        ...
        inputSchema: z.object({
            activity_name: z.string()
                ...
                .refine(val => /^sessions\/\d+\/activities\/\d+$/.test(val), { message: "Activity name must match format: sessions/123/activities/456" })
