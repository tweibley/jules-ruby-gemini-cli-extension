...
export async function execJulesJsonForMcp(
    ...
    try {
        // Optimization: Skip trimming output (trimOutput: false) to avoid unnecessary O(N) string allocation/copy
        // for large JSON payloads. JSON.parse handles whitespace natively.
        // Benchmark: Saves ~100ms on 10MB output.
