...
export async function execJulesJsonForMcp(
    ...
    try {
        // Optimization: Skip trimming output for JSON commands as JSON.parse handles whitespace
        // and avoiding trim() on large JSON strings saves significant memory and time.
